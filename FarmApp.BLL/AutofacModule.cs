...
namespace FarmApp.BLL
{
	public class AutofacModule : Module
	{
		...
		{
            //здесь бы я зарегистрировал в первую очередь FarmContext, обязательно InstancePerRequest
            ...
            //IMapper можно зарегистрировать как builder.RegisterInstance(AutoMapperConfig.GetMapper()).As<IMapper>(), чтобы он загрузил конфигурацию один раз
