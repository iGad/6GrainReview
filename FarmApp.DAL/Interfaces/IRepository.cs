...
namespace FarmApp.DAL.Interfaces
{
    ...
    //Я бы убрал IUnitOfWork, вместо IRepository оставил бы конкретную generic-реализацию (если не планируется смена ORM, что практически всегда так), от которой, в случае необходимости, можно было бы унаследоваться, и туда добавил бы SaveChangesAsync. 
    /// <summary>
